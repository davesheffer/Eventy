...
export default function AddEvent({ events, setEvents, menuToggle, setMenuToggle }) {
    ...
    return (
        <div className={menuToggleClasses}>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col">
                ...
                />
                <button className="bg-emerald-500 py-4 font-bold text-white">Save</button>
            </form>
        </div>
    );
}
